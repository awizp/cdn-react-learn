        ...
        <nav className="w-full py-3 relative">
            <div className="container mx-auto px-3 md:px-0 flex justify-between items-center">
                ...
                <div className="flex items-center justify-center gap-15">
                    <h1 className="text-2xl font-bold cursor-default"><Link to="/">Vishnuprakash</Link></h1>
                    ...
                    <ul className="hidden md:flex justify-center items-center font-semibold gap-5">
                        <li className="hover:text-gray-700 text-gray-500 cursor-pointer duration-300 transition">
                            <a href="https://portfolio-awizp.netlify.app/">About Me</a>
                        </li>
                        <li className="hover:text-gray-700 text-gray-500 cursor-pointer duration-300 transition">
                ...
                >
                    <Link to="/projects" className="hover:text-zinc-700 text-zinc-500 cursor-pointer duration-300 transition flex items-center gap-2">
                    ...
                    <ul className="flex flex-col justify-center items-start gap-3">
                        <li className="hover:text-zinc-700 text-zinc-500 cursor-pointer duration-300 transition">
                            <a href="https://portfolio-awizp.netlify.app/" className="flex items-center gap-2">
